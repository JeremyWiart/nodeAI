...
const {showAccount,formChangePassword,formChangeEmail} = require('./Controllers/accountController');
...
app.post('/AccountEmail', verifyToken,formChangeEmail)
app.post('/AccountPwd',verifyToken, formChangePassword)
